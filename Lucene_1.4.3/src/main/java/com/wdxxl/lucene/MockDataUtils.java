...
public class MockDataUtils {
    ...
    public static final String[] EMAILS = { "aa@wdxxl.com", "bb@wdxxl.com", "cc@wdxxl.com", "dd@sina.org",
            "ee@sinobot.org", "ff@sina.org" };
    public static final String[] CONTENTS = { "welcome to visit the space, hope you will like it", "hello like boy",
            "my name is cc I like nothing", "I like football", "I like football and I like basketball",
